...
LOG_ADD(LOG_FLOAT, topRight, &setpoint.motorControl.topRight)
LOG_ADD(LOG_FLOAT, topLeft, &setpoint.motorControl.topLeft)
LOG_ADD(LOG_FLOAT, bottomLeft, &setpoint.motorControl.bottomLeft)
LOG_ADD(LOG_FLOAT, bottomRight, &setpoint.motorControl.bottomRight)
